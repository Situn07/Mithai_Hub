    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">Fresh sweets made daily</p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 pt-8">
        <div className="rounded-3xl bg-gradient-to-r from-orange-500 via-amber-500 to-rose-500 text-white p-8 md:p-12 shadow-xl">
          ...
          <p className="mt-4 text-base md:text-lg opacity-90 max-w-2xl">
            Discover handcrafted sweets made with premium ingredients and
            traditional recipes.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl md:text-3xl font-bold">Our Sweets</h2>
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-orange-600 font-semibold mt-2">
                    From ₹{product.weightOptions[0].price}
                  </p>
